...
const Skills = () => {
    ...
    return (
        <section id='skills'>
            <motion.div variants={containerVaritans} initial='hidden' whileInView='visible' viewport={{ once: true, amount: 0.3 }} className="c_skills container-lg  py-lg-4 py-2 px-xl-5 px-1" >
